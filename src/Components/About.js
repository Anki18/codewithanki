      ...
      <div className="card-panel">
        ...
        <div className="flow-text">
          <span>
            ...
            <ul>
              <li>•	Worked on ReactJS project from scratch.</li>
              <li>•	Good understanding on Javascript and library like ReactJS/Redux.</li>
              <li>•	7.3+ yrs of experience in .Net with React Javascript for developing Web Application.</li>
            </ul>
          </span>
          <br />
          <div>
